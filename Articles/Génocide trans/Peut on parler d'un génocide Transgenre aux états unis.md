...
L'évolution des droits et de la reconnaissance des personnes transgenres aux États-Unis a été marquée par de nombreux obstacles. Malheureusement, depuis 2020, ces avancées ont été rétrogradées par l'adoption de lois anti-trans, des discours de haine virulents et des tragiques décès de personnes transgenres. Face à ces réalités choquantes, ne nombreuse personne, parle d'un génocide transgenre dans ce contexte. Cet article se propose d'examiner les éléments constitutifs cette appellation de génocide, de retracer l'historique des discriminations envers les personnes transgenres aux États-Unis, et d'analyser les arguments qualifiant ces violences comme un génocidaire.

## Qu'est ce qu'un génocide 

  
Avant d'examiner les éléments qualification ces violences envers les personnes transgenres aux États-Unis en tant que génocide, il est essentiel de comprendre la complexité et la gravité de ce terme. Le génocide est un concept qui englobe une définition légale mais aussi un processus destructeur en plusieurs étapes, telles que décrites par de nombreux chercheurs. Comprendre ces différentes étapes nous permettra d'évaluer si les réalités vécues par les personnes transgenres aux États-Unis correspondent à ce schéma. Ces étapes, qui seront abordées plus en détail ultérieurement, incluent la classification, la symbolisation, la discrimination, la déshumanisation, l'organisation, la polarisation, la préparation, l'extermination, la négation et enfin, la justice. En examinant ces étapes, nous serons en mesure d'analyser de manière approfondie si les conditions nécessaires pour qualifier les violences contre les personnes transgenres aux États-Unis de génocide sont présentes.
